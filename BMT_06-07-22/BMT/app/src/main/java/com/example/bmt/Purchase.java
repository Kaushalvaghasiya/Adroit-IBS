    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (con != null) {
                ...
                ArrayAdapter aa = new ArrayAdapter(Purchase.this, R.layout.spinner_list, list);
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(Purchase.this,R.style.DialogTheme, new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year,
                                ...
                                edfdate.setText(year + "-" + (monthOfYear + 1) + "-" + dayOfMonth);
                            }
                        }, mYear, mMonth, mDay);
