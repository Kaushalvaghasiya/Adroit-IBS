...
public class Payable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Payable.dialog = ProgressDialog.show(this, "", "Please wait...", true);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (con != null) {
                        ...
                        String q = "select acname from BillMst_Outstand_summary where FirmNo='"+fno+"';";
                        Statement st = con.createStatement();
                        ResultSet rs = st.executeQuery(q);
                        while (rs.next()) {
                ...
                edtdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(Payable.this,R.style.DialogTheme, new DatePickerDialog.OnDateSetListener() {
                            @Override
    ...
    public void getdata() {
        ...
        try {
            ...
            if (con != null) {
                String q="";
                if(btype.equals("All")) {
                    q = "select * from BillMst_Outstand_Summary where FirmNo='"+fno+"' order by AcName;";
                }
                else{
                    q = "select * from BillMst_Outstand_Summary where acname='"+btype+"' and FirmNo='"+fno+"' order by AcName;";
                }
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery(q);
                while (rs.next()) {
        ...
        payada = new radapter(this, ArrayList);
        LinearLayout ll = findViewById(R.id.btnLay);
        paging p = new paging(this,ll,10,payada,gvdata,"payada");
        p.Btnfooter();
        p.addata();
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                igdpdf.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dir.mkdirs();
                        String fileName = "purchase_outstanding_sales_aibs.pdf";
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (con != null) {
                                    ...
                                    cell1.add(new Paragraph("OUTSTANDING (PAYABLE)").setFontSize(12));
                                    String atdate = tdate;
...
//                                    PdfFont body = PdfFontFactory.createFont();
                                    ...
                                    q = "select count(*) as totalbill, sum(billamount) as billamount,sum(paidamt) as paid_amt, sum(unpaidamt) as unpaid_amt from BillMst_Outstand where FirmNo='" + fno + "' and BillDate <='"+tdate+"' and acname='" + ele.tcname + "';";
                                    st = con.createStatement();
                                    rs = st.executeQuery(q);
                                    while (rs.next()) {
                        ...
                        Uri f = FileProvider.getUriForFile(Payable.this, getApplicationContext().getPackageName() + ".provider", myFile);
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                LinearLayout ll = findViewById(R.id.btnLay);
                paging p = new paging(Payable.this,ll,10,payada,gvdata,"payada");
                p.Btnfooter();
                p.addata();
                return true;
            }
