...
import java.util.ArrayList;
class RecPopupCardin {
    String data1,data2,data3,data4,data5,data6,data7;

    public RecPopupCardin(String data1,String data2,String data3, String data4,String data5,String data6,String data7) {
        this.data1 = data1;
        this.data2 = data2;
        this.data3 = data3;
        this.data4 = data4;
...
class recinadapter extends ArrayAdapter<RecPopupCardin>{
    ArrayList<RecPopupCardin> ArrayList;
    public recinadapter(@NonNull Context context, ArrayList<RecPopupCardin> ArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (listitemView == null) {
            listitemView = LayoutInflater.from(getContext()).inflate(R.layout.pay_rec_ppcard_in, parent, false);
        }
        RecPopupCardin courseModel = getItem(position);
